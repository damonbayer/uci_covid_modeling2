---
title: "Santa Ana, CA COVID Situation Report Nov 15, 2020 - Dec 20, 2020"
...
results_folder <- "code/results/2020-11-15_2020-12-20/santa-ana"
city_name <- "Santa Ana"
...
## Santa Ana, CA COVID-19 Situation Report, `r format(last_day + 5, "%B %e, %Y")`
...
multi_chain_stem_fit$data %>% 
  dplyr::select(-start_date, -time, -prop_deaths_reported) %>% 
